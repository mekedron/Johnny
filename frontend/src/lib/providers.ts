...
// The three pipeline kinds. A fourth 's2s' kind (unified speech-to-speech)
// existed until Johnny-trt.43 removed the S2S surface; re-introduction is
// deferred to epic Johnny-20h (tombstone in docs/PIPELINE.md).
