...
| Executor engine + worker pass | Johnny-trt.22/24/26 | engine decision **done** (docs/TASK-ENGINE.md — hand-rolled asyncio, LangGraph rejected); worker pass + Phase-4 capstone planned |
