...
:class:`~app.services.session_scheduler.LaunchContext` (the active providers, the
agent snapshot's character prompt / behavior knobs, the assembled calendar +
cross-session context, the mode). This module turns that
